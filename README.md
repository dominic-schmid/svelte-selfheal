...
**Solution**: Always choose a separator character that will never appear in your ID or in your title. For UUIDs, use `~` or `_`. For numeric IDs, any separator is usually safe.
